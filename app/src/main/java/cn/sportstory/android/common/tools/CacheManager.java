...
public class CacheManager {
    ...
    public static String getCacheSize(Context context) throws Exception {
        ...
        //数据库
        totalSize += getFolderSize(new File("/data/data/" + context.getPackageName() + "/databases"));
        //缓存
//        totalSize += getFolderSize(context.getCacheDir());
        totalSize += getFolderSize(context.getExternalCacheDir());
        //文件
//        totalSize += getFolderSize(context.getFilesDir());
        return getFormatSize(totalSize);
    }

    public static boolean cleanApplicationCache(Context context) {
        cleanInternalCache(context);
        cleanExternalCache(context);
        cleanDatabases(context);
        try {
            String totalSize = getCacheSize(context);
        } catch (Exception e) {
